...
public class LibraryController {
	...
	@PostMapping("create")
	public Library create(@RequestBody Library student) throws Exception {
		Library result = null;
		try {
			result = libraryservice.create(student);
		} catch (Exception e) {
	...
	@GetMapping
	public List<Library> getall(@RequestParam(defaultValue = "0") Integer pageNo,
			@RequestParam(defaultValue = "0") Integer pageSize) {
		return libraryservice.getall(pageNo, pageSize);
	}
